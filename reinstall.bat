...
set confhome=https://raw.githubusercontent.com/yunhdeng/reinstall/main
set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/yunhdeng/reinstall/main
